...
def AreaJtForces(Model, LoadCases, Groups, Units=4, NLStatic=1, MSStatic=1, MVCombo=1):
    ...
    for i, item in enumerate(Groups):
        ...
        [NumberResults,Obj,Elm,PointElm,LoadCase,StepType,StepNum,F11,F22,F12,FMax,FMin,FAngle,FVM,M11,M22,M12,MMax,MMin,MAngle,V13,V23,VMax,VAngle,ret] = Model.Results.AreaForceShell("",3)
    ...
    Results = [FldNms,NumberResults,Obj,Elm,PointElm,LoadCase,StepType,StepNum,F11,F22,F12,FMax,FMin,FAngle,FVM,M11,M22,M12,MMax,MMin,MAngle,V13,V23,VMax,VAngle,Xcoord,Ycoord,Zcoord,ret]
